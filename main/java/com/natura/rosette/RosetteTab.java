...
public class RosetteTab extends CreativeTabs {
	...
	public void displayAllRelevantItems(NonNullList<ItemStack> items) {
		...
		List<Item> itemsInOrder = Arrays.asList(Item.getItemFromBlock(RosetteBlocks.beeHive), RosetteItems.honeyBucket, RosetteItems.honeyComb, RosetteItems.glazedApple, RosetteItems.strawberrySeeds, RosetteItems.strawberry, RosetteItems.blueberrySeeds, RosetteItems.blueberry, Item.getItemFromBlock(RosetteBlocks.blueberryBush), RosetteItems.pear, RosetteItems.orange, RosetteItems.bananna, RosetteItems.coconut, RosetteItems.cherry, RosetteItems.acorn, RosetteItems.acornCooked, RosetteItems.pineCone, Item.getItemFromBlock(RosetteBlocks.blackberryBush), RosetteItems.blackberry, Item.getItemFromBlock(RosetteBlocks.waxMushroom), RosetteItems.wax, Item.getItemFromBlock(RosetteBlocks.dandehue), Item.getItemFromBlock(RosetteBlocks.rubberLog), Item.getItemFromBlock(RosetteBlocks.rubberPlanks), RosetteItems.rubberBucket, RosetteItems.rubber, Item.getItemFromBlock(RosetteBlocks.roseQuartzOre), RosetteItems.roseQuartz, Item.getItemFromBlock(RosetteBlocks.roseQuartzBlock), Item.getItemFromBlock(RosetteBlocks.opalOre), RosetteItems.opal, RosetteItems.wineBottle, RosetteItems.obsidianShard, RosetteItems.adamantineIngot, RosetteItems.adamantinePickaxe);
