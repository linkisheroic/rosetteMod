...
public class PedestalGui extends GuiContainer {
		...
		private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Rosette.MODID, "textures/gui/pedestal.png");
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			String name = I18n.format(RosetteBlocks.pedestal.getUnlocalizedName() + ".name");
